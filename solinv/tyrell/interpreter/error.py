...
class EnumAssertion(InterpreterError):
    def __init__(self, context: Tuple[int, ...], condition: Callable[[Any], bool], tag: Any = None, info: Any = None):
        super().__init__()
...
class SkeletonAssertion(InterpreterError):
    def __init__(self, example: Any = None, prog: Any = None, tag: Any = None, info: Any = None):
        super().__init__()
...
class EqualityAssertion(InterpreterError):
    def __init__(self, tag: Any = None, info: Any = None):
        super().__init__()
        self._tag = tag
        self._info = info
