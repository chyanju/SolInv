...
contract ABL is StandardToken, OwnableToken {
    ...
    uint256 public totalSupply = (SUM * (10 ** uint256(18)));
    ...
    function ABL(
        ...
        balances[_dtb] = (DISTRIBUTION * (10 ** uint256(18)));
        emit Transfer(address(0), _dtb, balances[_dtb]);

        balances[_dev] = (DEVELOPERS * (10 ** uint256(18)));
...
//////////////////////
    function mint(
        ...
        uint256 amount = (_amount * (10 ** uint256(18)));
    ...
    function burn(
        ...
        totalSupply = (totalSupply - ((_amount * (10 ** uint256(18)))));
        balances[msg.sender] = ((balances[msg.sender]) - ((_amount * (10 ** uint256(18)))));

        emit Burn(msg.sender, (_amount * (10 ** uint256(18))));
        emit Transfer(msg.sender, address(0), (_amount * (10 ** uint256(18))));
    }
